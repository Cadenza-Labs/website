    ...
    <AppBar position="static" elevation={0}>
      <Toolbar disableGutters>
              <div className="logo" style={{display: { xs: 'flex', md: 'none' }}}>
                  <Link to="/">
                    <svg style={{ width: '150px', height: 'auto' }} fill="none" stroke-linecap="square" stroke-miterlimit="10" version="1.1" viewBox="0 0 450.16 65.761">
